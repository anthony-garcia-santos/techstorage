        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex gap-2">
              {productImages.map((img, i) => (
                <div
                  ...
                  className={`w-20 h-20 bg-muted rounded-lg cursor-pointer hover:ring-2 ring-primary overflow-hidden ${
          ...
          <div>
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-lg mb-6 whitespace-pre-line">{product.description}</p>
            </div>
